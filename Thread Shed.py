...
# Debug by printing the dictionaries below
#print(customers)
#print(sales)
#print(thread_sold)

# Determine the total value of all the day sales
total_sales = 0
for sale in sales:
...
# Determine number of times the item is equal to the argument color
...
print(color_count('white')) #Returned 28
    
# Determine and print a sentence that says how many threads of each color were sold today.
colors = ['red','yellow','green','white','black','blue','purple']
for color in colors:
  print(
    "Joseph sold {0} of {1} threads today."
